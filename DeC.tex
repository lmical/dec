...
{\bf from simple integration of systems of ordinary differential equations to explicit time-integration in Residual Distribution and Continuous and Discontinuous polynomial Galerkin FEM schemes for hyperbolic systems of balance laws} \\
\vspace{1.7cm}
\vspace{1.2cm}
...
%%
\item[•] Hence we present the Residual Distribution and the (stabilized) continuous polynomial Galerkin Finite Elements methods and show the connection between them. Thus we see how to apply the Deferred Correction in the context of these methods for which avoiding the inversion of the mass matrix without spoiling the accuracy of the scheme plays a crucial role.
